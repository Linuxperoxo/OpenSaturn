...
pub inline fn defaultBus(comptime default: types.EventDefault) struct { u2, u3 } {
...
pub inline fn checkPath(bus: u2, line: u3) bool {
    return if(main.event_buses[bus].line[line] != null) true else false;
}

pub inline fn retEvent(bus: u2, line: u3) *types.EventInfo {
