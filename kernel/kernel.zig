...
pub const arch: type = @import("saturn/arch/supported"); // FIX: Rename arch to supported
...
// kernel voce pode olhar o arquivo kernel/loader.zig, nele via ter toda
...
//  * E pronto, feito isso o bootloader apos carregar a imagem do kernel na ram,
