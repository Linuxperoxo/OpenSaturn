...
const out: type = struct {
    pub const b = @import("root").code.lib.kernel.io.ports.outb;
    pub const w = @import("root").code.lib.kernel.io.ports.outw;
    pub const l = @import("root").code.lib.kernel.io.ports.outl;
};

const in: type = struct {
    pub const b = @import("root").code.lib.kernel.io.ports.inb;
    pub const w = @import("root").code.lib.kernel.io.ports.inw;
    pub const l = @import("root").code.lib.kernel.io.ports.inl;
};
